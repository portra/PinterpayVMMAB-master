...
PACKAGELIST		glPackageList[MAX_PACKAGE];
uint 			counterPackage = 0;
uint			responseCounter = 0;
...
TRAN_CONFIG		glTranConfig[] =
{
	...
	{_T_NOOP("IM3"),          	"0200", "111000", PRN_RECEIPT+ACT_INC_TRACE+WRT_RECORD,0},
	...
	//resza add for Pinterpay ATA
	{_T_NOOP("PULSA"),		    "0200", "710000", PRN_RECEIPT+ACT_INC_TRACE},
	{_T_NOOP("CHECKSTATUS"),   	"0100", "710000", PRN_RECEIPT+ACT_INC_TRACE},
	{_T_NOOP("INQPPOB"),		"0100", "720000", 0},
	{_T_NOOP("PPOB"),			"0200", "720000", PRN_RECEIPT+ACT_INC_TRACE},	
	{_T_NOOP("INQPINTERPAY"),   "0100", "860000", 0},
	{_T_NOOP("PINTERPAY"),	    "0200", "860000", PRN_RECEIPT+ACT_INC_TRACE+IN_SALE_TOTAL+NEED_REVERSAL+WRT_RECORD},
	{_T_NOOP("PURCHASE_POIN"),  "0200", "401001", PRN_RECEIPT+ACT_INC_TRACE+IN_SALE_TOTAL+NEED_REVERSAL+WRT_RECORD},
	{_T_NOOP("PLNPRA"),  		"0200", "860000", PRN_RECEIPT+ACT_INC_TRACE},
