...
//BIT 2
	//==================================================================================
	memcpy(glProcInfo.stTranLog.szPan, "1234567890123456", 16);  // diki add
	sprintf((char *)glSendPack.szBit2,     "%.*s", LEN_PAN,      glProcInfo.stTranLog.szPan);
	//==================================================================================
...
//BIT 35
	//==================================================================================
	memcpy(glProcInfo.szTrack2, "1234567890123456=2103567890123456", 33);  // diki add
	sprintf((char *)glSendPack.szBit35, "%.*s", LEN_TRACK2, glProcInfo.szTrack2);
	//==================================================================================
...
//BIT 52
	...
	////{
		...
		memcpy(&glSendPack.szBit52[2], "\xc8\xe4\x77\x0c\x9f\xc7\x64\x44", 8);
