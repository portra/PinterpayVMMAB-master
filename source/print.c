...
//		PrnSetSmall();
		...
		} else if( glProcInfo.stTranLog.ucTranType==PINTERPAY)
		{
		
			PrnSetBig2();
			//szTranName 
			memset(szTranName, 0x00, sizeof(szTranName));  
			strcat(szTranName, "PURCHASE");
			//sprintf((char *)szBuff, "%s \n ", _T("  PINTERPAY"));
			sprintf((char *)szBuff, "  %s \n", szTranName);			
		}
		else
		...
		if(glProcInfo.stTranLog.ucTranType==PLNPRA){
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"AX100")){sprintf((char *)szBuff, "%s\n", _T("  AXIS 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"AX10")){sprintf((char *)szBuff, "%s\n", _T("  AXIS 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"AX25")){sprintf((char *)szBuff, "%s\n", _T("  AXIS 25RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"AX50")){sprintf((char *)szBuff, "%s\n", _T("  AXIS 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"AX5")){sprintf((char *)szBuff, "%s\n", _T("  AXIS 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"AX1")){sprintf((char *)szBuff, "%s\n", _T("  AXIS SERIBU"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"C100")){sprintf((char *)szBuff, "%s\n", _T("  CERIA 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"C10")){sprintf((char *)szBuff, "%s\n", _T("  CERIA 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"C20")){sprintf((char *)szBuff, "%s\n", _T("  CERIA 20RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"C50")){sprintf((char *)szBuff, "%s\n", _T("  CERIA 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"C5")){sprintf((char *)szBuff, "%s\n", _T("  CERIA 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"E100")){sprintf((char *)szBuff, "%s\n", _T("  ESIA 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"E10")){sprintf((char *)szBuff, "%s\n", _T("  ESIA 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"E11")){sprintf((char *)szBuff, "%s\n", _T("  ESIA 11RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"E15")){sprintf((char *)szBuff, "%s\n", _T("  ESIA 15RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"E20")){sprintf((char *)szBuff, "%s\n", _T("  ESIA 20RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"E25")){sprintf((char *)szBuff, "%s\n", _T("  ESIA 25RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"E50")){sprintf((char *)szBuff, "%s\n", _T("  ESIA 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"E5")){sprintf((char *)szBuff, "%s\n", _T("  ESIA 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"E1")){sprintf((char *)szBuff, "%s\n", _T("  ESIA SERIBU"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"F100")){sprintf((char *)szBuff, "%s\n", _T("  FLEXI 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"F10")){sprintf((char *)szBuff, "%s\n", _T("  FLEXI 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"F20")){sprintf((char *)szBuff, "%s\n", _T("  FLEXI 20RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"F50")){sprintf((char *)szBuff, "%s\n", _T("  FLEXI 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"F5")){sprintf((char *)szBuff, "%s\n", _T("  FLEXI 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"R100")){sprintf((char *)szBuff, "%s\n", _T("  FREN 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"R10")){sprintf((char *)szBuff, "%s\n", _T("  FREN 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"R25")){sprintf((char *)szBuff, "%s\n", _T("  FREN 25RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"R50")){sprintf((char *)szBuff, "%s\n", _T("  FREN 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"H100")){sprintf((char *)szBuff, "%s\n", _T("  HEPI 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"H10")){sprintf((char *)szBuff, "%s\n", _T("  HEPI 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"H25")){sprintf((char *)szBuff, "%s\n", _T("  HEPI 25RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"H50")){sprintf((char *)szBuff, "%s\n", _T("  HEPI 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"H5")){sprintf((char *)szBuff, "%s\n", _T("  HEPI 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"IT10")){sprintf((char *)szBuff, "%s\n", _T("  INDOSAT M2"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"IT25")){sprintf((char *)szBuff, "%s\n", _T("  INDOSAT M2"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"IT5")){sprintf((char *)szBuff, "%s\n", _T("  INDOSAT M2"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"IT50")){sprintf((char *)szBuff, "%s\n", _T("  INDOSAT M2"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"IG5")){sprintf((char *)szBuff, "%s\n", _T("  ISATGPRS 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"I100")){sprintf((char *)szBuff, "%s\n", _T("  ISATREGULER 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"I10")){sprintf((char *)szBuff, "%s\n", _T("  ISATREGULER 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"I20")){sprintf((char *)szBuff, "%s\n", _T("  ISATREGULER 20RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"I25")){sprintf((char *)szBuff, "%s\n", _T("  ISATREGULER 25"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"I50")){sprintf((char *)szBuff, "%s\n", _T("  ISATREGULER 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"I5")){sprintf((char *)szBuff, "%s\n", _T("  ISATREGULER 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"IS10")){sprintf((char *)szBuff, "%s\n", _T("  ISATSMS 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"IS25")){sprintf((char *)szBuff, "%s\n", _T("  ISATSMS 25RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"IS5")){sprintf((char *)szBuff, "%s\n", _T("  ISATSMS 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"CM100")){sprintf((char *)szBuff, "%s\n", _T("  SMART 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"CM10")){sprintf((char *)szBuff, "%s\n", _T("  SMART 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"CM20")){sprintf((char *)szBuff, "%s\n", _T("  SMART 20RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"CM50")){sprintf((char *)szBuff, "%s\n", _T("  SMART 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"CM5")){sprintf((char *)szBuff, "%s\n", _T("  SMART 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"O100")){sprintf((char *)szBuff, "%s\n", _T("  STARONE 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"O10")){sprintf((char *)szBuff, "%s\n", _T("  STARONE 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"O20")){sprintf((char *)szBuff, "%s\n", _T("  STARONE 20RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"O50")){sprintf((char *)szBuff, "%s\n", _T("  STARONE 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"O5")){sprintf((char *)szBuff, "%s\n", _T("  STARONE 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"S50")){sprintf((char *)szBuff, "%s\n", _T("  TELKOMSEL 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"S100")){sprintf((char *)szBuff, "%s\n", _T("  TELKOMSEL100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"S10")){sprintf((char *)szBuff, "%s\n", _T("  TELKOMSEL10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"S15")){sprintf((char *)szBuff, "%s\n", _T("  TELKOMSEL15RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"S20")){sprintf((char *)szBuff, "%s\n", _T("  TELKOMSEL20RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"S25")){sprintf((char *)szBuff, "%s\n", _T("  TELKOMSEL25RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"S5")){sprintf((char *)szBuff, "%s\n", _T("  TELKOMSEL5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"T100")){sprintf((char *)szBuff, "%s\n", _T("  THREE 100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"T10")){sprintf((char *)szBuff, "%s\n", _T("  THREE 10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"T20")){sprintf((char *)szBuff, "%s\n", _T("  THREE 20RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"T30")){sprintf((char *)szBuff, "%s\n", _T("  THREE 30RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"T50")){sprintf((char *)szBuff, "%s\n", _T("  THREE 50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"T5")){sprintf((char *)szBuff, "%s\n", _T("  THREE 5RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"T1")){sprintf((char *)szBuff, "%s\n", _T("  THREE SERIBU"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"XR100")){sprintf((char *)szBuff, "%s\n", _T("  XL100RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"XR50")){sprintf((char *)szBuff, "%s\n", _T("  XL50RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"XR20")){sprintf((char *)szBuff, "%s\n", _T("  XL20RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"XR10")){sprintf((char *)szBuff, "%s\n", _T("  XL10RB"));}
			if(strcmp(glProcInfo.stTranLog.szKodeProduk,"XR1")){sprintf((char *)szBuff, "%s\n", _T("  XL1RB"));}
			if(glProcInfo.stTranLog.ucTranType==PLNPRA){
				sprintf((char *)szBuff, "%s\n", glProcInfo.stTranLog.szToken);
			}
			if(glProcInfo.stTranLog.ucTranType==PLNPRA){
				PrnSetSmall();
			}else{
			...
			MultiLngPrnStr(szBuff, DISP_LINE_RIGHT);
			if(glProcInfo.stTranLog.ucTranType==PLNPRA){
				sprintf((char *)szBuff, "%s\n", glProcInfo.stTranLog.szNamaPelanggan);
				PrnSetNormal();
				MultiLngPrnStr(szBuff, DISP_LINE_RIGHT);
			}
		}
